...
Deterministic guardrails ensure symptoms such as pain, flashes, floaters, and sudden vision changes always trigger urgent recommendations.
...
| Testing | Synthetic CSV and standalone Python scripts |
